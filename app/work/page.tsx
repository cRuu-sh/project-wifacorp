...
export default function WorkHistory() {
    ...
    // Data tetap ada di sini biar nggak error 'Cannot find name'
    const careers = [
        {
            year: "2024 - Present",
    ...
    return (
        <main className="bg-[#1a1a1a] min-h-screen text-slate-900">
            ...
            {/* HERO SECTION - Background Full kayak di screenshot */}
            <section className="relative h-[70vh] w-full overflow-hidden">
                <Image
                    ...
                    priority
                />
                {/* Dark Overlay biar teks putihnya pop-up */}
                <div className="absolute inset-0 bg-black/40"></div>

                {/* Teks Hero Center */}
                <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-white text-6xl md:text-8xl font-black italic tracking-tighter uppercase">
                        Work History
                    </h1>
                    <p className="text-white/80 text-xl md:text-2xl mt-4 font-light tracking-widest italic uppercase">
                        Beyond Construction
                    </p>
                </div>
            </section>
            ...
            <section className="relative z-20 -mt-20">
                <div className="bg-white rounded-t-[60px] pt-20 pb-32 px-6 md:px-12 min-h-screen">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 uppercase inline-block relative mb-16">
                            Riwayat Pekerjaan
                        ...
                        <div className="space-y-16 text-left">
                            {careers.map((item, index) => (
                                <div key={index} className="group border-b border-slate-100 pb-12 transition-all hover:pl-4 duration-300">
                                    ...
                                    <h4 className="text-red-600 font-bold mb-4 uppercase text-sm tracking-widest">{item.company}</h4>
